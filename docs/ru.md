...
> **ƒ** &nbsp;RD AAOW FDL; 12.01.2025; 20:42
...
Больше информации Вы сможете найти в [этом видеоруководстве](https://youtu.be/PHqEliYvioY).
...
Для Windows:
- `Enter` – ввод значений в списки
- `Shift` + `Enter` – переход на следующий шаг
- `Home` – перезапуск последовательности
- `F1` – открытие окна О приложении
